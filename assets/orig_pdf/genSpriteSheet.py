...
# Example usage
input_dir = "png_images_player_pieces"  # Replace with your folder containing the images
output_sprite = "player_pieces.png"  # Replace with your desired output file
